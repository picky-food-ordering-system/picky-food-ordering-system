	...
	<body>
		<div class="mainbg">
			<div class="menu aniview" data-av-animation="fadeInDownBig">
				<div class="container">
					<div class="row">
						<div class="col-sm-3" style="margin: auto;"><a class="link" href="#">RESTAURANTS</a></div>
						<div class="col-sm-3" style="margin: auto;"><a class="link" href="#about">ABOUT</a></div>
						<div class="col-sm-3" style="margin: auto;"><a class="link" href="#contacts">CONTACT</a></div>
